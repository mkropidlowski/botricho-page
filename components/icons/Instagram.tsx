...
const Instagram = (props: SVGProps<SVGSVGElement>) => (
    <svg width="1em" height="1em" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <rect x={2} y={2} width={28} height={28} rx={6} fill="url(#instagram_svg__a)" />
        <rect x={2} y={2} width={28} height={28} rx={6} fill="url(#instagram_svg__b)" />
        <rect x={2} y={2} width={28} height={28} rx={6} fill="url(#instagram_svg__c)" />
